...
**Margarethe:** "Engagement 31 closes. — Reverend Patterson-Coyle, the board's chair-pro-tem, would you close the room."

Reverend Patterson-Coyle stands. He has been silent across the close-out until this moment.

**Reverend Patterson-Coyle:** "Margarethe, Renata, Adelaide, the institution's leadership and the firm's team and our vendor liaison and the Federal Reserve observer who left the bridge before this room reconvened — I'm not going to give a benediction; the firm I joined Brazos's board for is a bank, not a congregation. But I have been on this board for twenty years and I have sat through three merger close-outs before this one and I have not, before today, sat through one where the integration question — *can we prove what we did and didn't do* — was answered in six minutes by a verifier running across two clouds. The institutional question, when I joined this board in 2006, was whether the bank could survive an integration without losing customer trust. I am persuaded today that the institutional question's answer is the discipline this firm and this vendor and this chain have brought into the room. — The work compounds. — Margarethe, close the room."
